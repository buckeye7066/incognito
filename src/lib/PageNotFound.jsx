                ...
                <div className="text-center space-y-6">
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-purple-600 border border-purple-500 rounded-lg hover:bg-purple-700 transition-colors duration-200"
                        >
